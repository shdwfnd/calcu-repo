...
class Calculator:
    ...
    def create_display_frame(self):
        frame = tk.Frame(self.window, height=221, bg="Black", borderwidth=0)
    ...
    def create_digit_buttons(self):
        for digit, grid_value in self.digits.items():
            button = tk.Button(self.buttons_frame, text=str(digit), bg="gray1", fg="White",
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text="=", bg="chocolate1", fg="White", font=DEFAULT_FONT_STYLE,
